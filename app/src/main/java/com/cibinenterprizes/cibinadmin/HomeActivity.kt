...
class HomeActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        database.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                FirebaseInstanceId.getInstance().instanceId.addOnFailureListener { e ->
                    ...
                    if (it.isSuccessful) {
                        Common.updateToken(this@HomeActivity, it.result?.token.toString(), district)
        ...
        home_bins.setOnClickListener {
            startActivity(Intent(this, Bins::class.java))
        }
        home_drivers.setOnClickListener {
            startActivity(Intent(this, Drivers::class.java))
        }
        home_work_assigning.setOnClickListener {
            startActivity(Intent(this, WorkAssigning::class.java))
        }
        home_complaints.setOnClickListener {
            startActivity(Intent(this, Complaints::class.java))
        }
        home_work_report.setOnClickListener {
            startActivity(Intent(this, WorkReport::class.java))
        }
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        ...
        when(item.itemId){
            ...
            R.id.menu_terms_and_conditions -> startActivity(Intent(this, HomeActivity::class.java))
